<template>
  <div class="education">
    ...
    <div id="ans00">
      <h4 id="temp" style="text-align: center">
        School Closure Status(Overview by month from 2/16/20 to 7/16/21)
      </h4>
      <div style="margin-left: 5px; margin-bottom: -40px; magrin-top: 5px">
        <i class="legen" style="background: #ca0020; margin-right: 5px"></i
        ><b>Closed due to COVID-19</b>
        <i
          class="legen"
          style="background: #f4a582; margin-left: 20px; margin-right: 5px"
        ></i
        ><b>Partially open</b>
        <i
          class="legen"
          style="background: #92c5de; margin-left: 20px; margin-right: 5px"
        ></i
        ><b>Academic break</b>
        <i
          class="legen"
          style="background: #0571b0; margin-left: 20px; margin-right: 5px"
        ></i
        ><b>Fully open</b>
      </div>
    ...
    <div class="answer2">
      ...
      <h4 style="text-align: center">
        Duration of school closures(March 2020 - October 2021)
      </h4>
    ...
    <div id="pie_">
      <h4 id="temp" style="text-align: center">
        Learners Affected by COVID-19 during 2020(by School Type and Gender)
      </h4>
      ...
      <div id="dist" style="margin-top: 40px">
        ...
        <p style="font-size: 12px">
          <b>*Note: </b>The number of affected learners only accounts for
          learners where schools are <b>fully</b> closed due to COVID-19 during
          2020.
        </p>
      </div>
    </div>
    ...
    function bbb() {
      ...
      function redraw() {
        ...
        if (document.getElementById("close_type").value == "all_d") {
          ...
          ////////////////////////////////
          // DATA JOIN FOR NAMES.
          var name = svg.selectAll(".name").data(current, (d) => d.ISO);
          // UPDATE.
          name
            .transition()
            .duration(750)
