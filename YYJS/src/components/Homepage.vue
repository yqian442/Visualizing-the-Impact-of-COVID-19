  ...
  <div class="homebody">
    <h2>{{ msg }}</h2>
      ...
      This dashboard presents the worldwide impacts of Covid-19 from multiple dimensions, and it mainly visulize the answers to the folowing questions:  </p>
        <li style="margin-top:-20px;margin-left:190px;font-size:14px"> <i>How has the pandemic negatively impacted the public health system in different countries as times goes on? </i></li>
